...
/**
 * Fineract main() application which launches Fineract in an embedded Tomcat HTTP server (using Spring Boot), as well as
 * an embedded database (using MariaDB4j).
 *
...
public class ServerWithMariaDB4jApplication {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ServerWithMariaDB4jApplication.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!Desktop.isDesktopSupported()) {
            ...
            Resource distResource = ctx.getResource("file:" + System.getProperty("user.dir") + System.getProperty("file.separator") + "apps"
                    + System.getProperty("file.separator") + "community-app" + System.getProperty("file.separator") + "dist"
                    + System.getProperty("file.separator") + "community-app" + System.getProperty("file.separator") + "index.html");
            URI distURI = URI.create("https://localhost:8443/fineract-provider"
                    + "/apps/community-app/index.html?baseApiUrl=https://localhost:8443" + "&tenantIdentifier=default#/");

            // apps/community-app/app/index.html
            Resource devResource = ctx.getResource("file:" + System.getProperty("user.dir") + System.getProperty("file.separator") + "apps"
                    + System.getProperty("file.separator") + "community-app" + System.getProperty("file.separator") + "app"
                    + System.getProperty("file.separator") + "index.html");
            URI devURI = URI.create("https://localhost:8443/fineract-provider"
                    + "/apps/community-app/app/index.html?baseApiUrl=https://localhost:8443" + "&tenantIdentifier=default#/");
