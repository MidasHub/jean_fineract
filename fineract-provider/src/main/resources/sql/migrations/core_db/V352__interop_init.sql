...
INSERT INTO `m_appuser_role` VALUES ((SELECT id FROM m_appuser WHERE username = @interop_username COLLATE utf8mb4_general_ci), 1);
...
SET @code_id = -1;
SELECT id FROM m_code WHERE code_name = 'PaymentType' INTO @code_id;
